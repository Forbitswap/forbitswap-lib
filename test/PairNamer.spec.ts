...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'Forbitswap V2 Liquidity Provider Share for ', '.')).to.eq(
        'Forbitswap V2 Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
